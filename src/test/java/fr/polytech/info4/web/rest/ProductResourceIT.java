...
import static fr.polytech.info4.web.rest.TestUtil.sameNumber;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().price(DEFAULT_PRICE).disponibility(DEFAULT_DISPONIBILITY).description(DEFAULT_DESCRIPTION);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().price(UPDATED_PRICE).disponibility(UPDATED_DISPONIBILITY).description(UPDATED_DESCRIPTION);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.price(UPDATED_PRICE).disponibility(UPDATED_DISPONIBILITY).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.price(UPDATED_PRICE).disponibility(UPDATED_DISPONIBILITY).description(UPDATED_DESCRIPTION);

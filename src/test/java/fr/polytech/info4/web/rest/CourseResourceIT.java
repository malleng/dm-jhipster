...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().state(DEFAULT_STATE).deliveryTime(DEFAULT_DELIVERY_TIME);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().state(UPDATED_STATE).deliveryTime(UPDATED_DELIVERY_TIME);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.state(UPDATED_STATE).deliveryTime(UPDATED_DELIVERY_TIME);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.state(UPDATED_STATE).deliveryTime(UPDATED_DELIVERY_TIME);

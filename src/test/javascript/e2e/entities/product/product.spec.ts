...
describe('Product e2e test', () => {
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.disponibilitySelectLastOption(),
      productUpdatePage.setDescriptionInput('description'),
      productUpdatePage.basketSelectLastOption(),
      productUpdatePage.restaurantSelectLastOption(),
    ]);
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('coopcycleApp.product.delete.question');
